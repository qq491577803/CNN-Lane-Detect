...
if __name__ == "__main__":
    ...
    res ,_,_= draw_lane(img)
    end = time.time()
    print(end-begin)
    cv2.imshow("img", res)
    cv2.waitKey(0)

    # original_video = r'C:\Users\Administrator\Desktop/25.mp4'
    # video = VideoFileClip(original_video)
    # output_video = video.fl_image(precess)
    # output_video.write_videofile('./25.mp4',audio =False)

    # original_video = r'./videos/input/lane.mp4'
